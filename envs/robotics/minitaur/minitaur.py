...
from chaosbreaker.envs.robotics.minitaur.motor import MotorModel
...
class Minitaur(object):
    ...
    def __init__(self,
        ...
        self._action_history = collections.deque(maxlen=3)
    ...
    def Step(self, action):
        ...
        self._action_history.appendleft(np.array(action))
    ...
    def GetMotorAcceleration(self):
        if len(self._action_history) >= 3:
            v0 = self._action_history[0] - self._action_history[1]
            v1 = self._action_history[1] - self._action_history[2]
            return v0 - v1
        return 0.
