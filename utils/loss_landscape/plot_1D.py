...
def plot_1d_loss(surf_file, xmin=-1.0, xmax=1.0, loss_max=5, log=False, show=False):
    print('------------------------------------------------------------------')
...
def plot_1d_loss_repeat(prefix, idx_min=1, idx_max=10, xmin=-1.0, xmax=1.0,
    ...
    pp.savefig(prefix + '_1d_loss_repeat.pdf', dpi=300, bbox_inches='tight', format='pdf')
...
if __name__ == '__main__':
    ...
    if args.prefix:
        plot_1d_loss_repeat(args.prefix, args.idx_min, args.idx_max,
                                args.xmin, args.xmax, args.loss_max, args.show)
    else:
        plot_1d_loss(args.surf_file, args.xmin, args.xmax, args.loss_max, args.log, args.show)
