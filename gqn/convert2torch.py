...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, required=True, help='data directory with all datasets')
    ...
    ## test
    file_names = _get_dataset_files(dataset_info, 'test', args.data_dir)
